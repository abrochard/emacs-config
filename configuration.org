...
go-mode yasnippet avy helm win-switch emmet-mode elfeed elfeed-org smooth-scrolling
...
Function to open the current file in browser. Thanks to [[https://github.com/purcell/emacs.d/blob/master/lisp/init-utils.el#L78]]
#+BEGIN_SRC emacs-lisp
