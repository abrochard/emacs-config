...
go-mode yasnippet avy helm win-switch emmet-mode
multiple-cursors which-key anaconda-mode viking-mode undo-tree
projectile helm-projectile flx helm-flx diminish ag helm-ag
whole-line-or-region exec-path-from-shell xkcd neotree))
#+END_SRC
...
(diminish-minor-mode 'WLR 'whole-line-or-region-mode)
#+END_SRC
