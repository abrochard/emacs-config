...
go-mode yasnippet php-auto-yasnippets avy helm win-switch emmet-mode
...
Had to disable that on Windows until I figure out proper image support
#+BEGIN_SRC emacs-lisp
;; (require 'xkcd)
;; (xkcd)
